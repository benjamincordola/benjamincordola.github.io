...
Our updated paper can be found at this [GitHub Repository](https://github.com/benjamincordola/RPr-Malcomb-2014). You can view a [HTML Document](https://benjamincordola.github.io/RPr-Malcomb-2014/) here, but __I was not able to knit to html for my final revisions because of problems with Groundhog downloading packages to my mac. It could not open this url: [https://cran.rstudio.com/bin/macosx/big-sur-arm64/contrib/4.3/rgdal_1.6-7.tgz](https://cran.rstudio.com/bin/macosx/big-sur-arm64/contrib/4.3/rgdal_1.6-7.tgz) which is in fact 404 not found. I am not sure how to get around this, as it is baked into the groundhog function.
